var DeviantProjects = XMLLoader("http://backend.deviantart.com/rss.xml?type=deviation&q=gallery%3Areversenorm%2F60005484");
		...
		function DeviationGalleryBuilder(DeviationNumber){
			...
			var htmlString="<div class='closeX'><a href='#d' onclick="+'toggleOffAllGalleries(); '+"align='right'>[X]</a></div><div id='PreviousArrow'><a href='#"+PerviousDeviation+"' onclick='openDeviation("+PerviousDeviation+", "+null+");'><img src="reversenorm.github.io/Images/Previous.png" height="75%"></a></div><div id='liveDeviation' ><div id='liveDeviationTitle'>";//add in the gallery description section
			...
			htmlString = htmlString.concat("</div><div id='NextArrow'><a href='#"+NextDeviation+"' onclick='openDeviation("+NextDeviation+", "+null+");'><img src="reversenorm.github.io/Images/Next.png" height="75%"></a></div>");//close LiveDeivation Div and add nextDeviation button link
